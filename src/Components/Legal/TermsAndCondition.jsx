...
const TermsAndCondition = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="pt-28 bg-gray-700 px-4 md:px-8">
        <h1 className="text-3xl text-white font-bold mb-4">
          TERMS OF USE OF REDEFINE GROUP
        </h1>
        <p className="mb-4 text-gray-100">
          Welcome to Redefine Group’s Terms of Use for Website. This Website is
          created and operated by Doon Hatcheries Limited. This legal agreement
          is an electronic record in terms of Indian Information Technology Act,
          2000 and rules there under as applicable and the amended provisions
          about electronic records in various statutes as amended by the Indian
        ...
        <p className="mb-4 text-gray-100">
          ...
          Website and the services provided by the Redefine Group on the Website
          “www.redefinegroup.com”.
        </p>
        ...
        <p className="mb-4 text-gray-100">
          ...
          Website and/or the Redefine Group, as the context so requires. “You”,
          “Your”, “Yourself”, “User” shall mean and refer to natural and legal
          individuals who shall be Users of this Website provided by the
          Redefine Group and who is competent to enter into binding contracts,
          as per Indian laws. “Third Parties” refer to any Website, Platform or
          individual apart from the Users and the creator of this Website.
          “Website” refers to the Website created by the Redefine Group. 
        </p>
        <h2 className="text-2xl font-bold mt-6 text-white">GENERAL TERMS</h2>
        <ul className="list-disc ml-6 mb-4 text-gray-100">
          <li>
            The headings of each section in these Terms of Use or Privacy Policy
            ...
            legal or contractual value on You using the Website.
          </li>
          <li>
            ii.The use of this Website by You is solely governed by these Terms
            of Use, Privacy Policy that may be uploaded on the Website and any
          ...
          <li>
            You expressly agrees and acknowledges that these Terms of Use and
          ...
          <li>
            iv.You unequivocally agree that these Terms of Use and the Privacy
            Policy constitute a legally binding agreement between You and Us,
            and that You shall be subject to the rules, guidelines, policies,
            terms, and conditions applicable to your use of the Website, and
            that the same shall be deemed to be incorporated into these Terms of
            Use and shall be treated as part and parcel of the same. You
            acknowledge and agree that no signature or express act is required
            to make these Terms of Use and the Privacy Policy binding on You and
            that your act of visiting any part of the Website constitutes the
            User’s full and final acceptance of these Terms of Use and the
            Privacy Policy.
          </li>
          <li>
            ...
            You expressly agrees that any such amendments or modifications shall
        ...
        <h2 className="text-2xl font-bold mt-6 text-white">REGISTRATION</h2>
        <p className="mb-4 text-gray-100">
          You are required to register yourself on the Website in order to avail
          the Website and its services. For the purpose of registration, you
          shall be required to provide the Email Id on the registration link
          available on the homepage of the Website. The Registrations shall be
          deemed complete only upon your's authentication and verification of
          your's details through email authentication. As a responsible Website,
          we do not let you link your social media with the Website for
          registration purpose or otherwise.
        </p>

        <h2 className="text-2xl font-bold mt-6 text-white">ELIGIBILITY</h2>
        <ul className="list-disc ml-6 mb-4 text-gray-100">
          <li>
            ...
            following the Law. However, if you are minor using this Website, you
            may do so with the consent of your legal guardian. All Acts of minor
            shall be deemed to be considered as the acts undertaken under the
        ...
        <h2 className="text-2xl font-bold mt-6 text-white">PAYMENT GATEWAY</h2>
        <p className="font-bold text-white py-2">Payments and Payment Gateway</p>
        <ul className="list-disc ml-6 mb-4 text-gray-100">
          <li>
            The Website is integrated with a payment gateway to facilitate
            transactions.
          </li>
          <li>
            Transactions may include either recurring subscriptions or one-time
            purchases, with specific renewal periods defined at the time of the
            transaction.
          </li>
        </ul>

        <p className="font-bold py-2 text-white">International Orders</p>
        <ul className="list-disc ml-6 mb-4 text-gray-100">
          <li>
            The Website is designed primarily for domestic transactions, and
            international orders are not permitted unless otherwise specified.
          </li>
        </ul>

        <p className="font-bold text-white py-2">Cancellation, Returns, and Refunds</p>
        <ul className="list-disc ml-6 mb-4 text-gray-100">
          <li>
            <strong>Cancellation Notice:</strong> Subscription cancellations
            must be initiated with a notice period as defined during the
            transaction process.
          </li>

          <li>
            <strong>Refund/Return Policy:</strong>Refunds (if applicable) will
            be processed under circumstances specified at the time of purchase.
          </li>

          <li>
            Certain conditions or exclusions may apply, which will be provided
            in detail during the transaction process
          </li>

          <li>
            No cancellation or refund request shall be honored after the
            designated number of days from the purchase date.
          </li>
        </ul>

        <h2 className="text-2xl font-bold mt-6 text-white">CONTENT</h2>
        <div className="text-gray-100">
          ...
          <p>
            ...
            Further, the Website reserves its right to suspend the account of
            any User for an indefinite period to be decided at the discretion of
            the Website or to terminate the account of any User who is found to
            have created or shared or submitted any content or part thereof that
            is found to be untrue/inaccurate/misleading or offensive/vulgar. You
          ...
          <p>
            Please note that once the fee is paid, no refunds will be issued
            under any circumstances. The program fee is final and
            non-refundable.
          </p>
        </div>

        <h2 className="text-2xl font-bold mt-6 text-white">INDEMNITY</h2>
        <div className="text-gray-100">
          <p className="font-bold">
            ...
            result from, or maybe payable by, any breach or non-performance of
            any representation, warranty, covenant or agreement made or
            obligation to be performed according to these Terms of Use. Further,
            You agrees to hold the Us harmless against any claims made by any
        ...
        <div>
          ...
          <p className="text-gray-100 py-2">
            The Founders/ Promoters/ Partners/ Associated people of Redefine
            Group are not responsible for any consequences arising out of the
            following events:
          </p>
          ...
          <p className="text-gray-100">
            ...
            into this Terms of Use by reference. d.The Website expressly
            excludes any liability for any loss or damage that was not
            reasonably foreseeable by the Website and which is incurred by you
            in connection with the Website, including loss of profits; and any
            loss or damage incurred by you as a result of your breach of these
            Terms of Use. e.To the fullest extent permitted by law, We shall not
        ...
        <div>
          <h2 className="text-2xl font-bold mt-6 text-white">Term</h2>
          <ul className="list-disc ml-6 mb-4 text-gray-100">
            <li>
              These Terms of Use shall continue to form a valid and binding
              contract between You and Us and shall continue to be in full force
              and effect until You continues to access and use the Websites.
            </li>
            ...
            <li>
              ...
              Website at any time and for any reason, if any discrepancy or
              legal issue arises.
            </li>
          </ul>
        </div>
        ...
        <div>
          <h2 className="text-2xl font-bold mt-6 text-white">COMMUNICATION</h2>
          ...
          <p className="text-gray-100">
            You can report to “Support@redefinegroup.com” if you find any
            discrepancy with regard to Website or content-related information
            and We will take necessary action after an investigation.  The
            ...
            notwithstanding anything contained hereinabove, it may be contacted
            by Us relating to any services availed by You on the Website or
            anything pursuant thereto and You agree to indemnify Us from any
            harassment claims. It is expressly agreed to by Us that any
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4 text-gray-100">
            <li>
              ...
              restrictions. Prohibited actions include uploading fake property
              documents, misusing property data, and sharing property documents
              without proper consent. Users are solely responsible for any
              content they upload, affirming they have the necessary rights and
              permissions. The Company reserves the right to remove content that
              violates these Terms.
            </li>

            <li>
              Agree to provide genuine credentials during the process of
              registration on the Website. You shall not use a fictitious
              identity to register. We are not liable if You have provided
              incorrect information
            </li>

            <li>
              c.Agree to ensure the Name, Email address, Address, Mobile number
              and any such other information provided during account
              registration is valid at all times and shall keep your information
              accurate and up-to-date.
            </li>

            <li>
              d.You agree that You are solely responsible for maintaining the
            ...
            <li>
              ...
              of Services, marketing and promotional purposes and for
            ...
            <li>
              k.Users have the option to switch to the next available batch or
              program before the commencement of the current batch. However,
              once the reversal program has started, switching to a different
              batch is not allowed. During the course of the program, switching
              to a different batch is not feasible. Participants who wish to
              join a future batch must withdraw from the current program and
              re-enroll in the desired batch, subject to availability and
              applicable fees. Once the program has commenced, refunds will not
              be provided on the grounds of being unable to follow the program
              protocols. The program is structured to support participants at
              various levels of engagement, and personalized assistance is
              available to help overcome challenges. Participants are encouraged
              to seek guidance and make necessary adjustments to stay on track.
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4 text-gray-100">
            ...
            <li>
              ...
              affiliated or linked and Websites.
            </li>
            ...
            <li>
              ...
              disrupts the Services of any other supplier/service provider of
              the Website;
            </li>

            <li>
              You hereby expressly authorize Us to disclose any and all
              information relating to You in our possession to law enforcement
              or other government officials, as We may in our sole discretion,
            ...
            <li>
              ...
              the right to confirm and validate the information and other
              details provided by You at any point in time. If upon confirmation
              such details are found to be false, not to be true (wholly or
              partly), We shall in our sole discretion reject the registration
              and debar You from using the Website without prior intimation
              whatsoever.
            </li>
            <li>
              ...
              specifically, You agree not to host, display, upload, update,
            ...
            <li>
              The platform may provide general legal advice, property pricing
              estimates, or market insights. However, these are for
              informational purposes only and should not substitute professional
              advice tailored to individual needs. The Company does not
              guarantee the accuracy of property details or data sourced from
              third parties. Liability for any claims is limited to the amount
              paid by the user for the specific service, with maximum liability
              determined based on the nature of the service.
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-100 py-2">
            ...
            in our sole discretion, limit the You access and/or activity by
          ...
          <ul className="list-disc ml-6 mb-4 text-gray-100">
            <li>
              If you are in breach any of these Terms of Use or the Privacy
              Policy;
            </li>
            ...
            <li>
              c.If your actions may cause any harm, damage or loss to the other
        ...
        <div>
          ...
          <p className="text-gray-100 py-2">
            ...
            shall give You a right to use any of the Website’s trade names,
            trademarks, service marks, logos, domain names, information,
            questions, answers, solutions, reports and other distinctive brand
            features, save according to the provisions of these Terms of Use.
            ...
            are the property of the Website or the respective copyright or
            trademark owner. Furthermore, concerning the Website, we shall be
            the exclusive owner of all the designs, graphics and the like,
            related to the Website.
          </p>
          <p className="text-gray-100">
            You shall not use any of the intellectual property displayed on the
            Website in any manner that is likely to cause confusion among
            existing or prospective Users of the Website, or that in any manner
            disparages or discredits the Website, to be determined in the sole
            discretion.
          </p>
          <p className="text-gray-100">
            ...
            merely provide the Website through which the You can communicate
            with other users and the Website does not own any of the
            intellectual property relating to the independent content displayed
            on the Website, apart from created graphics and specified content.
          </p>
          <p className="text-gray-100">
            You are further aware that any reproduction or infringement of the
            intellectual property of the aforementioned owners by You will
            result in legal action being initiated against You by the respective
            owners of the intellectual property so reproduced/infringed upon. It
            is agreed to by You that the contents of this Section shall survive
            even after the termination or expiry of these Terms of Use and/or
            Privacy Policy.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4 text-gray-100">
            <li>
              ...
              judgment before availing any features on the Website or
              accessing/using any information displayed thereon.
            </li>

            <li>
              You agree that any kind of information, resources, activities,
              recommendations obtained/availed from Website, written or oral,
            ...
            <li>
              ...
              and You hereby expressly accepts any associated risks involved
            ...
            <li>
              While we strive for our Expert Services to be beneficial, it is
              important to understand, agree, and acknowledge that they may not
              be suitable for everyone's needs or appropriate for every specific
              situation. Our services may not serve as a substitute for certain
              mental health requirements that necessitate in-person therapy
              services, such as active substance withdrawal or anorexia nervosa
              treatment.
            </li>
          </ul>
        </div>
        ...
        <div>
          <h2 className="text-2xl font-bold mt-6 text-white">FORCE MAJEURE</h2>
          <p className="py-2 text-gray-100">
            ...
            of God, earthquake, riot, fire, festive activities sabotage, labour
        ...
        <div>
          ...
          <p className="py-2 text-gray-100">
            ...
            interpretation, and performance of these Terms of Use and any
            disputes arising therefrom will be resolved through Arbitration. It
            is further agreed to by You that the contents of this Section shall
          ...
          <p className="text-gray-100 ">
            ...
            unable to amicably resolve a dispute, the said dispute will be
            referred to arbitration by a sole arbitrator to be appointed by Us,
            and the award passed by such sole arbitrator will be valid and
            binding on all parties. All cost of the Arbitration shall be borne
            solely in accordance with the Arbitrators award. The arbitration
            shall be conducted in English, and the seat of Arbitration shall be
            the city of Delhi, India.  You expressly agree that the Terms of
            Use, Privacy Policy and any other agreements entered into between
            the Parties are governed by the laws, rules, and regulations of
            India.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc ml-6 mb-4 text-gray-100">
            <li>
              ...
              Policy, form the complete and final contract between the You and
              Us with respect to the subject matter hereof and supersedes all
            ...
            <li>
              ...
              performance of any provision of these Terms of Use shall in no
              manner affect such Party's right at a later time to enforce the
              same. No waiver by either party of any breach of these Terms of
              Use, whether by conduct or otherwise, in any one or more
            ...
            <li className="pb-10">
              Contact Us: If you have any questions about these Terms of Use or
              the Privacy Policy, the practices of the Website, or your
              experience, you can contact us at Support@redefinegroup.com
            </li>
          </ul>
        </div>
      </div>
